...
const KEYWORD_DATA = {
  R: [ // 현실형 (Realistic) - 파랑
    '솔직', '검소', '지구력 강함', '신체적 건강', '소박', '말수 적음', '고집', '단순함', '활동적',
    '실용적', '현재 중심적', '사물 지향적', '직선적', '구체적', '기계적 적성', '운동 능력', '손재주', '도구 조작',
    '기술적', '조립', '수리', '생산적', '견고함', '강인함', '야외 활동', '기계 다루기', '몸으로 하는 일'
  ],
  I: [ // 탐구형 (Investigative) - 연한 파랑
    '호기심 많음', '지식 체계화', '비판적 사고', '지적 추구', '합리적', '학업 열망', '내성적', '가설 검증', '논리적', '관찰적',
    '상징적', '체계적 사고', '지적 창의성', '자기 주도 학습', '과학적', '추상적 사고', '탐구 정신', '이론적', '연구 지향적', '객관적',
    '수학적', '실험적', '복잡한 사고', '지적 호기심', '연구 열정', '정보 수집', '탐구심', '심층 분석', '문제 해결'
  ],
  A: [ // 예술형 (Artistic) - 주황
    '표현력 풍부', '독창적', '비순응적', '감성적', '직관적', '미적 감각', '상상력', '창작 욕구', '심미안',
    '예술적', '감정적', '개성적', '자유로움', '혁신적', '표현 욕구', '영감적', '심미적', '감수성', '몽상적',
    '표현적', '즉흥적', '자발적', '비전통적', '변화 추구', '개방적', '색채 감각', '감성적 표현', '미적 완성도'
  ],
  S: [ // 사회형 (Social) - 초록
    '협력적', '헌신적', '친근함', '이타적', '공감 능력', '관계 지향적', '타인 중심적', '이상주의적', '도움 지향적', '친절함',
    '이해심', '배려심', '봉사 정신', '인간관계 중시', '교육적', '상담적', '치료적', '돌봄', '화합 추구', '봉사적',
    '동정심', '양육적', '격려적', '지지적', '공동체 의식', '인도적', '관용적', '수용적', '공감적'
  ],
  E: [ // 진취형 (Enterprising) - 빨강
    '추진력', '경영 감각', '야심적', '설득력', '지배적', '경쟁 지향적', '위험 감수', '에너지 넘침', '자신감', '네트워킹',
    '낙관주의', '인기', '리더십', '영향력', '목표 지향적', '성취 욕구', '권력 추구', '외향적', '적극적', '결단력',
    '통제력', '야망적', '협상력', '열망', '성과 지향', '성공 지향', '목표 달성', '경영적', '기업가적'
  ],
  C: [ // 관습형 (Conventional) - 보라
    '꼼꼼함', '문서화', '질서 선호', '보수적', '규칙 준수', '순응적', '양심적', '절제력', '효율성', '신뢰성',
    '절차 중심', '차분함', '사무 처리', '계획적', '체계적 실행', '정확성', '세심함', '오류 최소화', '전통적', '안정성',
    '일관성', '성실함', '인내심', '데이터 정리', '절차 지향적', '규범적', '규칙 기반', '반복 작업', '기록 정리'
  ]
};
...
...`;
      ...
      promptEnv = aiIntro + `저는 홀랜드 검사 결과 주 강점 유형이 **[${topTypeInfo.name}]**이고, 직무 핵심 키워드는 **[${topKeywordLabels}]**입니다.
직업 선택 시 가장 중요하게 여기는 가치관은 **[${valLabels}]**입니다.
${birkmanTextEnv}${tciText}이 데이터를 바탕으로 나의 에너지가 충전되고 가장 편안함을 느끼는 환경이 어떤 곳인지 분석하고, 구체적으로 어떤 조직 문화와 제도를 가진 회사에 가야 하는지 3가지 측면에서 제안해주세요.`;
      ...
      promptBestBoss = aiIntro + `저는 홀랜드 검사 결과 주 강점 유형이 **[${topTypeInfo.name}]**이고, 직무 핵심 키워드는 **[${topKeywordLabels}]**입니다.
${birkmanTextBoss}직장 생활에서 **[${valLabels}]**의 가치를 중요하게 생각합니다.
...
저에게 어떤 식으로 업무 지시를 내리고 어떻게 피드백을 주는 상사가 좋은지 구체적인 롤모델을 그려주세요.`;
      ...
      const worstBossIntro = birkmanContext
        ? `저는 홀랜드 검사 결과 주 강점 유형이 **[${topTypeInfo.name}]**이고, 직무 핵심 키워드는 **[${topKeywordLabels}]**입니다.\n${birkmanTextStress}(직장 가치관: [${valLabels}])`
        : `저는 홀랜드 검사 결과 주 강점 유형이 **[${topTypeInfo.name}]**이고, 직무 핵심 키워드는 **[${topKeywordLabels}]**입니다.\n직장 생활에서 **[${valLabels}]**의 가치를 중요하게 생각합니다.`;
